          ...
          ({ pathExampleApp }) => startPipelineStageWithProperties(
            ...
            ({ jsonPath }) => startPromisePipeline(
              ...
              () => Promise.resolve().then(
                ...
                () => (jsonfile.readFileSync(jsonPath, { fs }))
              ).catch((e) => {
              ...
              (json) =>
                // returns the updated example JSON data:
                ({
                  ...json,
                  scripts: {
              ...
              (jsonOutput) => Promise.resolve(
                jsonfile.writeFileSync(jsonPath, jsonOutput, { fs, spaces: 2 })
              )
            ),
            thenStartPipelineStageWithProperties(
